...
- ログインフォーム (ユーザー名とパスワードの入力欄とログインボタン)
- パスワード忘れた場合のリンク
- 新規登録のリンク
...
- ユーザー名
- ユーザーが所属している部活動名
- ユーザーのアクティビティ数（過去 7 日間）
- お気に入りした投稿の一覧
- 投稿した記事の一覧
- 草の成長記録画面
  - 一定期間ごとの草の成長状況グラフ
  - 草の成長に関するコメント欄
  - 過去の草の成長記録を閲覧するためのスクロール機能
...
- 画面タイトル「お気に入り一覧」
- お気に入り投稿のリスト表示（タイトル、投稿日時、投稿者ユーザー名、投稿内容の一部）
- 投稿をクリックすると、その投稿詳細画面に遷移
- ページネーション機能（10 件ごとにページング）
- ヘッダーに「新規投稿」と「ログアウト」のリンクを表示

## 草の成長記録画面（ユーザープロフィール画面内）
