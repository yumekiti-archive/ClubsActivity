...
section 要件定義
要件定義     :done,    des1, 2023-04-01, 15d
要件仕様書作成 :done,    des2, after des1,      15d

section 開発
設計         :done,    des3, after des2,      15d
実装         :active,  des4, after des3, 45d
単体テスト   :         des5, after des4,      10d
結合テスト   :         des6, after des5,      10d
システムテスト :        des7, after des6,      15d

section 保守・運用
リリース      :        des8, after des7,      15d
保守・運用    :        des9, after des8,      137d
```
